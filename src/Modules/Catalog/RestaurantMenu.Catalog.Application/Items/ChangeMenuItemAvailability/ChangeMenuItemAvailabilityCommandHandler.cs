...
public sealed class ChangeMenuItemAvailabilityCommandHandler
    : ICommandHandler<ChangeMenuItemAvailabilityCommand, Result<long>>
{
    ...
    public async Task<Result<long>> Handle(
        ChangeMenuItemAvailabilityCommand command,
        CancellationToken cancellationToken)
    {
        ...
        menuItem.ChangeAvailability(command.IsAvailable);
