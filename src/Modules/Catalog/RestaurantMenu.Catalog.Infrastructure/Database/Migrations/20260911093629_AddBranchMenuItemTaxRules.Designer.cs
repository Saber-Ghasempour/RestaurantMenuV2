...
namespace RestaurantMenu.Catalog.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260911093629_AddBranchMenuItemTaxRules")]
    partial class AddBranchMenuItemTaxRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantMenu.Catalog.Domain.Taxation.BranchMenuItemTaxRule", b =>
                {
                    b.Property<Guid>("BranchId")
                        .HasColumnType("uuid")
                        .HasColumnName("branch_id");
                    ...
                    b.ToTable("branch_menu_item_tax_rules", "catalog", t =>
                        {
                            t.HasCheckConstraint("ck_branch_menu_item_tax_rules_behavior", "behavior IN ('Inclusive', 'Exclusive')");

                            t.HasCheckConstraint("ck_branch_menu_item_tax_rules_rate", "rate_basis_points BETWEEN 0 AND 10000");
                        });
                });
